...
CREATE  TABLE IF NOT EXISTS `discgolf`.`statistics_user_profiles` (
  ...
  `year_score` DOUBLE NULL DEFAULT NULL ,
  `slovak_champ_score` DOUBLE NULL DEFAULT NULL ,
...
-- -----------------------------------------------------
-- Table `discgolf`.`statistics_lap`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `discgolf`.`statistics_lap` ;

CREATE  TABLE IF NOT EXISTS `discgolf`.`statistics_lap` (
  `lap_id` INT NOT NULL AUTO_INCREMENT ,
  `number` INT NULL ,
  `tournament_id` INT(11) NOT NULL ,
  `user_id` INT(11) NOT NULL ,
  PRIMARY KEY (`lap_id`, `tournament_id`, `user_id`) ,
  INDEX `fk_laps_statistics_tournaments1` (`tournament_id` ASC) ,
  INDEX `fk_laps_statistics_user_profiles1` (`user_id` ASC) ,
  CONSTRAINT `fk_laps_statistics_tournaments1`
    FOREIGN KEY (`tournament_id` )
    REFERENCES `discgolf`.`statistics_tournaments` (`tournament_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_laps_statistics_user_profiles1`
    FOREIGN KEY (`user_id` )
    REFERENCES `discgolf`.`statistics_user_profiles` (`user_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `discgolf`.`statistics_basket`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `discgolf`.`statistics_basket` ;

CREATE  TABLE IF NOT EXISTS `discgolf`.`statistics_basket` (
  ...
  INDEX `fk_basket_lap1` (`lap_id` ASC) ,
  CONSTRAINT `fk_basket_lap1`
    FOREIGN KEY (`lap_id` )
    REFERENCES `discgolf`.`statistics_lap` (`lap_id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `discgolf`.`statistics_slovak_champ`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `discgolf`.`statistics_slovak_champ` ;

CREATE  TABLE IF NOT EXISTS `discgolf`.`statistics_slovak_champ` (
  `id_slovak_champ` INT NOT NULL AUTO_INCREMENT ,
  `nmbr_accept_tourn` INT NULL ,
