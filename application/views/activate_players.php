...
else
{
	...
	echo '<table border="1"><tr><th>First Name</th><th>Last name</th><th>Date of birth</th><th>email</th><th>Gender</th><th>Club</th><th>Auto Created</th><th>Activate</th><th>Delete</th><th>Reject Activation</th></tr>';
	foreach ($players as $player){
		...
		echo '<td><form action="/discgolf/index.php/auth/admin_activate_player/'.$player['user_id'].'"> <input type="submit" value="Activate" onclick="return confirm(\'Are you sure you want to activate profile with email: '.$player['email'].'?\')" /></form></td>
		<td><form action="/discgolf/index.php/auth/admin_delete_player/'.$player['user_id'].'"> <input type="submit" value="Delete" onclick="return confirm(\'Are you sure you want to delete profile and all results with email: '.$player['email'].'?\')" /></form></td>
