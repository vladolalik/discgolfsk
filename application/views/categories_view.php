...
<?php 
	...
	foreach ($categories as $key => $value) {
		echo '<tr>
				...
				<td ><form action="'.base_url().'index.php/tournaments/admin_delete_cat/'.$value['category_id'].'"> <input style="margin:auto;" type="submit" value="Delete" onclick="return confirm(\'Are you sure you want to delete '.$value['category'].' category?\')" /></form></td>
			 </tr>';
	}
	echo '</table>';
