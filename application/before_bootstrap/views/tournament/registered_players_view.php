...
<table class="center-table">
	<tr>
<?php
	echo form_open('/tournaments/registered_players', array('class' => 'ajax-form-reg-players'));
	echo '<td>'.form_label('Tournaments', 'reg-players').'</td>';
	echo '<td><select name="tournaments" id="reg-players">';
	...
	foreach ($data['tournaments'] as $key => $value) {
	 ...
	 echo '</select></td>';
	 echo '<td class="form-button">'.form_submit('view', 'View').'</td>';
     echo form_close();
?>
</tr>
</table>
